  ...
  return (
    <div className="bg-[#b27d71]">
      <ul className="flex">
        <li>
          <a href="https://www.facebook.com/ilesdepaix">
            <svg
              ...
              height="1em"
              viewBox="0 0 24 24"
              className="w-10 h-10 ml-8 hover:text-[#491c13]"
            >
              <path
                fill="currentColor"
        ...
        <li>
          <a href="https://www.instagram.com/ilesdepaix/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
              height="1em"
        ...
        <li>
          <a href="https://twitter.com/IlesDePaix">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
              height="1em"
        ...
        <li>
          <a href="https://www.youtube.com/user/ilesdepaix">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
              height="1em"
        ...
        <li>
          <a href="https://www.linkedin.com/company/iles-de-paix/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
              height="1em"
